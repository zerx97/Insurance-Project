// Hand-drawn line icons, one per policy category, each carrying its own accent color
// (defined in index.css as --cat-auto / --cat-home / --cat-life / --cat-health).
// Deliberately not a generic icon-font pack - these are custom-built so the shapes and
// stroke weight match the ledger/document identity of the rest of the app.

export function AutoIcon({ size = 40 }: { size?: number }) {
  return (
    <svg width={size} height={size} viewBox="0 0 48 48" fill="none">
      <path
        d="M8 30 L11 20 Q12 17 16 17 H32 Q36 17 37 20 L40 30"
        stroke="var(--cat-auto)" strokeWidth="2.2" strokeLinecap="round" strokeLinejoin="round"
      />
      <rect x="6" y="30" width="36" height="9" rx="2.5" stroke="var(--cat-auto)" strokeWidth="2.2" />
      <circle cx="14" cy="39" r="3.2" fill="var(--parchment)" stroke="var(--cat-auto)" strokeWidth="2.2" />
      <circle cx="34" cy="39" r="3.2" fill="var(--parchment)" stroke="var(--cat-auto)" strokeWidth="2.2" />
  ...
  return (
    <svg width={size} height={size} viewBox="0 0 48 48" fill="none">
      <path
        ...
        stroke="var(--cat-home)" strokeWidth="2.2" strokeLinecap="round" strokeLinejoin="round"
      />
...
export function LifeIcon({ size = 40 }: { size?: number }) {
  return (
    <svg width={size} height={size} viewBox="0 0 48 48" fill="none">
      <path
        d="M24 38 C10 29 6 21 10 15 C13.5 10 20 10.5 24 17 C28 10.5 34.5 10 38 15 C42 21 38 29 24 38 Z"
        stroke="var(--cat-life)" strokeWidth="2.2" strokeLinejoin="round"
      />
...
export function HealthIcon({ size = 40 }: { size?: number }) {
  return (
    <svg width={size} height={size} viewBox="0 0 48 48" fill="none">
      <path
        d="M24 8 L38 14 V23 C38 33 32 39 24 42 C16 39 10 33 10 23 V14 Z"
        stroke="var(--cat-health)" strokeWidth="2.2" strokeLinejoin="round"
      />
...
export function ShieldIcon({ size = 40 }: { size?: number }) {
  return (
    <svg width={size} height={size} viewBox="0 0 48 48" fill="none">
      <path
        d="M24 6 L40 12 V22 C40 33 33 40 24 43 C15 40 8 33 8 22 V12 Z"
        stroke="var(--brass)" strokeWidth="2.2" strokeLinejoin="round"
      />
      <path d="M17 23 L22 28 L32 17" stroke="var(--brass)" strokeWidth="2.4" strokeLinecap="round" strokeLinejoin="round" />
    </svg>
  );
}
